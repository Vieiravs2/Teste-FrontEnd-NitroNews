...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  var inputNome = document.querySelector('input[name=\"nome\"]');\n  var inputEmail = document.querySelector('input[name=\"email\"]');\n  var inputSenha = document.querySelector('input[name=\"senha\"]');\n  inputNome.addEventListener('input', myFunction);\n  inputEmail.addEventListener('input', myFunction);\n  inputSenha.addEventListener('input', myFunction);\n  function myFunction(event) {\n    console.log('Estou sendo chamado');\n  }\n});\n\n//# sourceURL=webpack://frontend/./src/index.js?");
